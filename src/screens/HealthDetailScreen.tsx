...
import { StyleSheet, Text, View, SafeAreaView, ViewStyle, TouchableWithoutFeedback } from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View
        ...
        <TouchableWithoutFeedback onPress={() => navigation.navigate('HealthCheck')}>
