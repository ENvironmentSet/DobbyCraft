...
const WhatsappShareIcon = () => {
    ...
    {
      return(
        <Image style={{width:50, height:50, alignSelf:'center', marginBottom: 5}} source={require('../assets/whatsapp-ios.png')}></Image>
        );
    }else if(Platform.OS == 'android')
    {
      return(
        <Image style={{width:50, height:50, alignSelf:'center', marginBottom: 5}} source={require('../assets/whatsapp-android.png')}></Image>
      );
    }
  }
    ...
    render(){
        return(
            <View style={styles.ShareArea}>
                ...
                <Image source={require('../assets/facebook.png')} style={{width:50, height:50, alignSelf:'center', marginBottom: 5}}></Image>
                <Text>Facebook</Text>
                </TouchableOpacity>
                </View>
                <View style={styles.ShareItems}>
                ...
                <Image source={require('../assets/twitter.png')} style={{width:50, height:50, alignSelf:'center', marginBottom: 5}}></Image>
                <Text>Twitter</Text>
                </TouchableOpacity>
                </View>
                <View style={styles.ShareItems}>
                ...
                <Image source={require('../assets/more.png')} style={{width:50, height:50, alignSelf:'center', marginBottom: 5}}></Image>
